...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/css/Template_Front_End_Components/style.css') }}" />
    ...
    <div class="clever-main-menu">
        <div class="classy-nav-container breakpoint-off">
            ...
            <nav class="classy-navbar justify-content-between" id="cleverNav">
                ...
                <!-- Logo -->
                <a class="nav-brand" href="index.blade.php" style="width: 100px;"><img src="{{ asset('img/core-img/logo3.png')}}" alt="" style="width:100%;"></a>
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li><a href="Template_Front_End_Components/index.html">Home</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                            ...
                            <li><a href="Template_Front_End_Components/courses.html">Courses</a></li>
                            <li><a href="Template_Front_End_Components/instructors.html">Instructors</a></li>
                            <li><a href="Template_Front_End_Components/blog.html">Blog</a></li>
                            <li><a href="Template_Front_End_Components/contact.html">Contact</a></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="footer-logo">
                        <a href="index.blade.php"><img src="img/core-img/logo3.png" alt="" style="width: 100px;"></a>
                    </div>
                    <!-- Copywrite -->
...
<!-- All Plugins js -->
{{--<script src="js/plaasins/plugins.js"></scriaas>--}}
<script src = "{{ asset('/js/plugins/plugins.js')}}"></script>
<!-- Active js -->
{{--<script src="js/acaasve.js"></script>--}}
